...
import { Menu, X, Book, BookOpen, Activity, Server, Settings, Home } from 'lucide-react';
            ...
            <div className="flex items-center">
              ...
              <div className="ml-3 flex items-center">
                <img
                  ...
                  className="h-8 w-8"
                />
                <h1 className="ml-2 text-xl font-bold text-gray-900">InkOS Studio</h1>
              </div>
            </div>
            <div className="flex items-center">
              <div className="ml-4 flex items-center md:ml-6">
                ...
                <div className="ml-3 relative">
                  <div>
                    <button className="max-w-xs bg-white flex items-center text-sm rounded-full focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary" id="user-menu-button" aria-expanded="false" aria-haspopup="true">
          ...
          <div className="h-full flex flex-col">
            ...
            <div className="border-t border-gray-200 p-4">
              <div className="px-2 space-y-1">
                <a
                  href="https://github.com/actalk-ai/inkos"
                  target="_blank"
